...
class MealPlanProvider with ChangeNotifier {
  ...
  List<Map<String, String>> _dates = [
    ...
    {'date': '1.30 (금)', 'title': '2일차 (기사문)', 'id': '1.30'},
    {'date': '1.31 (토)', 'title': '3일차 (인구항)', 'id': '1.31'},
    {'date': '2.1 (일)', 'title': '4일차 (남애항)', 'id': '2.1'},
    {'date': '2.2 (월)', 'title': '5일차 (수산항)', 'id': '2.2'},
    {'date': '2.3 (화)', 'title': '6일차 (대포항)', 'id': '2.3'},
    {'date': '2.4 (수)', 'title': '7일차 (속초항)', 'id': '2.4'},
